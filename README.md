...
| <a name="input_create_and_attach_storage"></a> [create\_and\_attach\_storage](#input\_create\_and\_attach\_storage) | if you do not want blob stoage created and mapped to the container change this to false | `bool` | `true` | no |
